  ...
  return (
    <main>
      <section id="home" className="relative min-h-screen">
        <NavBar />
        <HomePageBG />
        <div className="title-box absolute bottom-1/2 mx-4 w-auto max-w-[440px] translate-y-1/2 lg:left-20">
          <div className="mb-5 border-4 border-black bg-White p-3 pr-6 leading-snug">
            <p className="text-2xl font-bold sm:text-4xl">GDSC NCKU FORUM</p>
            <p className="text-2xl font-bold sm:text-4xl">成大學生開發者論壇</p>
            <p className="text-lg sm:text-xl">2024.06.08 (Sat.) 09:00-17:00</p>
            <p className="text-lg sm:text-xl">成功大學 光復校區 國際會議廳</p>
          </div>
          ...
          <div className="flex flex-col flex-wrap gap-5 sm:flex-row">
            ...
            <Dialog>
              ...
              <DialogContent className="max-h-[90%] max-w-[80%] overflow-scroll">
                <a className="underline" href="/site_map.png" download>
                  點此下載
                </a>
                <Image
                  src="/site_map.png"
            ...
            <Dialog>
              <DialogTrigger className="nav-item w-36 text-lg hover:bg-gray-300">
                <TruckIcon className="mr-1 inline size-6" />
                交通路線
              </DialogTrigger>
              <DialogContent className="max-h-[90%] max-w-[80%] overflow-scroll">
                ...
                <p>
                  搭乘高鐵至台南站，轉搭乘臺鐵沙崙線至臺南火車站下車，自後站出口至大學路西段，步行二百公尺後，左側即為光復校區前門，進入校區後，依指標至國立成功大學國際會議廳。
                </p>
                <h2 className="text-xl font-bold">搭乘台鐵</h2>
                <p>
                  於臺南火車站下車，自後站出口至大學路西段，步行二百公尺後，左側即為光復校區前門，進入校區後，依指標至國立成功大學國際會議廳。
                </p>
                <h2 className="text-xl font-bold">自行開車</h2>
                <h3 className="text-lg font-semibold">1.車行南下：</h3>
                <p>
                  國道一號下大灣交流道（324公里處），下交流道後沿高速二街直行至復興路右轉，沿復興路直行續接小東路，左轉勝利路，右轉大學路西段，左轉由光復校區前門進入，停車於校園內。依指標至國立成功大學國際會議廳。
                </p>
                <h3 className="text-lg font-semibold">2.車行北上：</h3>
                <p>
                  國道一號下仁德交流道（327A裕農路）方向，沿高速一街一段直行，續至高速一街二段，於復興路左轉，沿復興路直行續接小東路，左轉勝利路，右轉大學路西段，左轉由光復校區前門進入，停車於校園內。依指標至國立成功大學國際會議廳。
                </p>
              </DialogContent>
            </Dialog>
            <a
              className="nav-item w-36 text-lg hover:bg-gray-300"
              href="https://youtu.be/MWK4geiYARs?si=9Q2pBTfZAygdFwO1"
              target="_blank"
            >
        ...
        <div className="absolute bottom-0 w-full bg-[#1C1C1C] p-2 text-3xl">
          <div class="box-border w-full overflow-hidden whitespace-nowrap">
            <code className="inline-block animate-[marquee_10s_linear_infinite] pl-[120%] text-White">
              Code to goal, Fuel your soul！
            </code>
          </div>
        </div>
      </section>
      ...
      <section id="info" className="gap-4 bg-Red px-10 py-14 sm:px-20">
        ...
        <div className="text-lg text-White">
          ...
          <p>
            邀請眾多在資訊產業耕耘的專業人士，分享他們的寶貴經驗與洞察，促進學生對業界之認識。
          </p>
          <br />
          ...
          <p>
            今年度社團成員們共計進行了 9 組專案，主題包含 AI、Big
            data、Web、Unity......等。我們將藉由海報展攤位與簡報
            Showcase，向會眾分享開發經驗與技術細節，並評選出大家心目中第一名的專案
            🏆{" "}
          </p>
          <br />
          ...
          <ul className="list-inside list-disc">
            <li>
              精美禮品抽獎：現場報到並完成人氣投票任務，即可抽{" "}
              <b>ITFIT 系列筋膜槍</b>、<b>空氣清淨機</b>、<b>手持吸塵器</b>、
              <b>手目耳 $2680 配鏡券</b>、<b>$1680 墨鏡券</b>...等眾多好禮！
            </li>
            <li>
              社群攤位交流：與資安社、數位行銷社、區塊鏈社...等社群合作，擴展技術人脈～
            </li>
            <li>
              提供茶水與下午茶甜點：讓大家在緊湊的活動中，也能享受一下午的美好時光～
            </li>
          </ul>
        </div>
      </section>
      ...
      <section id="partners" className="bg-Blue px-10 py-14 sm:px-20">
        ...
        <div className="mb-6 flex flex-wrap justify-center gap-10">
          <a
            href="https://www.falken.com.tw/hersheys/kisses/index/"
            target="_blank"
          >
            <Image
              src="/sponsors/HSY.png"
              alt="HERSHEY'S"
              width={120}
              height={120}
            />
          ...
          <a
            href="https://www.paolyta.com.tw/"
            target="_blank"
            className="flex items-center justify-center"
          >
            <Image
              src="/sponsors/保力達.jpg"
              alt="保力達"
              width={120}
              height={120}
            />
        ...
        <div className="flex flex-wrap justify-center gap-10">
          <a
            href="https://www.instagram.com/ncku.dmc"
            target="_blank"
            className="flex items-center justify-center"
          >
            <Image
              src="/community/ncku_dmc_logo.png"
              alt="成大數位行銷社"
              width={120}
              height={120}
            />
          ...
          <a href="https://www.instagram.com/nckuctf/" target="_blank">
            <Image
              src="/community/ncku_ctf_logo.png"
              alt="成大資安社"
              width={120}
              height={120}
            />
          ...
          <a
            href="https://www.instagram.com/nckublockchainclub/"
            target="_blank"
          >
            <Image
              src="/community/ncku_blockchain_club_logo.jpg"
              alt="成大區塊鏈社"
              width={120}
              height={120}
            />
          ...
          <a href="https://www.instagram.com/ncku_tricking/" target="_blank">
            <Image
              src="/community/ncku_tricking_logo.png"
              alt="成大 Tricking 社"
              width={120}
              height={120}
            />
          ...
          <a
            href="https://www.facebook.com/profile.php?id=61555579555321"
            target="_blank"
          >
            <Image
              src="/community/foi_logo.jpg"
              alt="台灣不分系協會"
              width={120}
              height={120}
            />
          ...
          <a href="https://www.act.club.tw/" target="_blank">
            <Image
              src="/community/agile_tw_logo.png"
              alt="台灣敏捷協會"
              width={120}
              height={120}
            />
      ...
      <footer className="flex flex-col justify-between bg-[#1C1C1C] px-10 py-6 text-White sm:flex-row">
        <div>
          <ul className="mb-2 flex gap-4 text-White">
            <li>
              <a href="https://gdscncku.com" target="_blank">
          ...
          聯絡我們：
          <a href="mailto:GDSC.club@gs.ncku.edu.tw" className="underline">
            GDSC.club@gs.ncku.edu.tw
          </a>
